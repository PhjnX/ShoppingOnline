      ...
      return (
        ...
        >
          <td
            data-lable="ID"
            scope="row"
            class="break-words text-sm md:text-[16px] cursor-pointer px-6 py-3  text-gray-600"
          >
            {item._id}
          </td>
          <td
          ...
          <td
            data-lable="Image"
            className="text-sm md:text-[16px] px-6 py-3 cursor-pointer text-right shadow lg:shadow-none"
          >
            <img
              className="w-[50px] h-[70px] lg:w-full lg:h-[80px] text-right ml-auto"
    ...
    const pagination = Array.from(
      ...
      (_, index) => {
        if (index + 1 === this.state.curPage) {
          return (
            <button className="mr-2 w-[30px] h-[30px] rounded-full bg-[#f18634] text-black">
              <span key={index}>
                {" "}
                <b>{index + 1}</b>{" "}
              </span>
          ...
          return (
            <button className="mx-2 transition-all w-[30px] h-[30px] rounded-full hover:bg-[#f18634] hover:text-black hover:font-bold">
              <span key={index} onClick={() => this.lnkPageClick(index + 1)}>
                {" "}
                {index + 1}{" "}
              </span>
            </button>
    ...
    return (
      <div className="container-xl py-[40px] flex-row xl:justify-between xl:flex space-x-3">
        <div className="">
          ...
          <Typography className="active-bar text-center p-0 lg:pt-3">
            {pagination}
          </Typography>
        </div>
        <div />
