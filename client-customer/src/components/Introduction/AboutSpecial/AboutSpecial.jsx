    ...
    <div className="grid grid-cols-3 gap-8 items-center py-20 container-80">
      <div className="flex space-x-3">
        ...
        <div>
          ...
          <p className="text-[#353535] leading-6 font-normal">
            Hiện nay, converse là một trong những thương hiệu giày được giới trẻ
            ưa chuộng và quan tâm trên khắp cả nước.
          </p>
        </div>
      </div>
      ...
      <div className="flex space-x-3">
        ...
        <div>
          ...
          <p className="text-[#353535] leading-6 font-normal">
            Các mẫu mã được trải qua từng khâu kiểm định để đưa đến cho khách
            hàng một sản phẩm tốt nhất
          </p>
        </div>
      </div>
      ...
      <div className="flex space-x-3">
        ...
        <div>
          ...
          <p className="text-[#353535] leading-6 font-normal">
            Được hoàn trả một đôi giày mới khi phát hiện lỗi từ khâu may vá hay
            sản xuất
          </p>
        </div>
      </div>
      ...
      <div className="flex space-x-3">
        ...
        <div>
          ...
          <p className="text-[#353535] leading-6 font-normal">
            Có thể đổi size nếu không vừa khi đặt hàng online với điều kiện vẫn
            còn đầy đủ tem mác
          </p>
        </div>
      </div>
      ...
      <div className="flex space-x-3">
        ...
        <div>
          ...
          <p className="text-[#353535] leading-6 font-normal">
            Giao hàng miễn phí tận nơi trên khắp các tỉnh thành
          </p>
        </div>
      </div>
      ...
      <div className="flex space-x-3">
        ...
        <div>
          ...
          <p className="text-[#353535] leading-6 font-normal">
            Một đôi giày chất lượng với giá cả phải chăng dễ tiếp cận với tất cả
            các người dùng
          </p>
        </div>
      </div>
