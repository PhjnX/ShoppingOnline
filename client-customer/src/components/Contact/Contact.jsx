...
export default function Contact() {
  return (
    ...
    <div className="pt-32 container-80">
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.5241762997343!2d106.6669814104619!3d10.771107089333062!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f5f7aef7e55%3A0xa258af3c450d4bb5!2sConverse!5e0!3m2!1svi!2s!4v1721063205581!5m2!1svi!2s"
        className="w-full h-[400px]"
        allowfullscreen=""
        loading="lazy"
      ...
      <div className="grid grid-cols-3 gap-8 items-center py-20 container">
		...
		s-33.645,75-75,75C125.265,239.397,91.62,205.752,91.62,164.397z"
          ...
          <div>
            ...
            <p className="text-[#353535] leading-6 font-normal">
              11 Đ. Sư Vạn Hạnh, Phường 12, Quận 10, Hồ Chí Minh
            </p>
          </div>
        </div>
		...
		C354.001,458.429,351.311,470.408,346.544,481.271z"
          ...
          <div>
            ...
            <p className="text-[#1c1c1c] leading-6 font-bold">0967225657</p>
            <p className="text-[#353535] leading-6 font-normal">
              Bấm 191 – Phòng kinh doanh
            </p>
            <p className="text-[#353535] leading-6 font-normal">
              Bấm 202 – Phòng chăm sóc khách hàng
            </p>
          </div>
        </div>
        ...
        <div className="flex space-x-3">
          ...
          <div>
            ...
            <p className="text-[#353535] leading-6 font-normal">
              1 đổi 1 nếu phát hiện lỗi từ khâu sản xuất
            </p>
          </div>
        </div>
      </div>
